<?php
 class Member extends Model {
	 ...
	 public function get_models($id) {
		 $case_studies = $this->db->fetch('SELECT cxm.*, cm.title AS m_title FROM case_x_members cxm, case_studies cs WHERE cxm.case_study_id = ? AND cxm.team_member_id = cm.id', array($id));
		 return $case_studies;
	 }
