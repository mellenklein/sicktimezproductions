...
$model = new SortModel('shop_product_images');
$product_model = new Model ('shop_products');
$galleries = $product_model->get_items();


if( isset($_GET['product_id']) ){
	
	$sql="SELECT  p.* FROM shop_product_images p WHERE p.product_id = ? ORDER BY p.sort";
...
if($action == 'add' || $action == 'edit'){
	...
	$upload_dir = $config->get('admin_upload_img_dir').'shop/';
...
<table class="cms_table">
  ...
  <tbody class="sortable" rel="shop-product-photos">
