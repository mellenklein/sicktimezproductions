...
if($action == 'update'){
	...
	foreach($rlocs_arr AS $k => $v) {
		...
		$v['restaurant_id'] = $id;
		$loc_parts = array($v['address'], $v['city'], $v['state'], $v['zip'], $v['country']);
		...
		<div id="rlocs-shell">
			<?php if(!empty($all_r_locs)): ?>
				<?php foreach($all_r_locs AS $rloc): ?>
					...
					<fieldset id="rloc_<?php echo $cur_r_loc_count; ?>" class="rloc_fieldset">
						...
						<div class="form_field">
							<label>Country</label>
							<input class="in_text" type="text" name="rlocs_arr[<?php echo $cur_r_loc_count; ?>][country]" id="" value="<?php echo $rloc['country']; ?>" />
						</div>
						
						<div class="form_field">
							<label>Phone</label>
							<input class="in_text" type="text" name="rlocs_arr[<?php echo $cur_r_loc_count; ?>][phone]" id="" value="<?php echo $rloc['phone']; ?>" />
						</div>
			...
			<?php else: ?>
				...
				<fieldset id="rloc_<?php echo $cur_r_loc_count; ?>" class="rloc_fieldset">
					...
					<div class="form_field">
						<label>Country</label>
						<input class="in_text" type="text" name="rlocs_arr[<?php echo $cur_r_loc_count; ?>][country]" id="" value="" />
					</div>
					
					<div class="form_field">
						<label>Phone</label>
						<input class="in_text" type="text" name="rlocs_arr[<?php echo $cur_r_loc_count; ?>][phone]" id="" value="" />
					</div>
				</fieldset>
			<?php endif; ?>
		</div>
...
<div id="rloc-template" style="display: none;">
	<fieldset id="rloc_{{rloc_count}}" class="rloc_fieldset">
		...
		<div class="form_field">
			<label>Country</label>
			<input class="in_text" type="text" name="rlocs_arr[{{rloc_count}}][country]" id="" value="" />
		</div>
		
		<div class="form_field">
			<label>Phone</label>
			<input class="in_text" type="text" name="rlocs_arr[{{rloc_count}}][phone]" id="" value="" />
		</div>
