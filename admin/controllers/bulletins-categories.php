<?php
$model = new SortModel('bulletins_categories');
$items = $model->get_items(array('order' => 'sort'));
$item = array();
$item_names = array(
	'singular'=>'Service Bulletin Category',
	'plural'=>'Service Bulletin Categories'
);
$view = 'list';
...
<table class="cms_table">
  ...
  <tbody class="sortable" rel="bulletins-categories">
